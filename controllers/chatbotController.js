...
//       return res.json({
//         response: `Your last order status is: ${order.status}. Delivery status: ${order.deliveryStatus || 'Not Assigned'}.`,
...
//     if (lowerMessage.includes('popular') || lowerMessage.includes('suggest')) {
...
//         suggestions: ['Order now', 'View menu'],
//       });
//     }

//     // Fallback
//     return res.json({
//       response: "Sorry, I didn't understand that. Try asking about your orders, the menu, or popular items.",
//       suggestions: ['Show menu', 'Track my order', 'Suggest food'],
//     });
//   } catch (error) {
